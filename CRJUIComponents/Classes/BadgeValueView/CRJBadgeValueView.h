...
typedef NS_ENUM(NSUInteger, CRJBadgePosition) {
    
    CRJBadgePositionCenterLeft,
    CRJBadgePositionCenterRight,
    
    CRJBadgePositionTopLeft,
    CRJBadgePositionTopRight,
    
    CRJBadgePositionBottomLeft,
    CRJBadgePositionBottomRight,
};

@interface CRJBadgeValueView : UIView
 ...
 */
@property (nonatomic)  CRJBadgePosition  position;
...
/*
 ...
 {
     CRJBadgeValueView *badgeView = [[CRJBadgeValueView alloc] init];
     badgeView.contentView     = rectView;
     badgeView.sensitiveWidth  = 30.f;
     badgeView.position        = CRJBadgePositionCenterLeft;
 ...
 
 {
     CRJBadgeValueView *badgeView = [[CRJBadgeValueView alloc] init];
     badgeView.contentView     = rectView;
     badgeView.position        = CRJBadgePositionTopLeft;
