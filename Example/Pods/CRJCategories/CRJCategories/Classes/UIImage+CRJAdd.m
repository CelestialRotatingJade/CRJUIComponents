...
- (UIImage *)crj_imageByRoundCornerRadius:(CGFloat)radius {
    return [self crj_imageByRoundCornerRadius:radius borderWidth:0 borderColor:nil];
}

- (UIImage *)crj_imageByRoundCornerRadius:(CGFloat)radius
                             borderWidth:(CGFloat)borderWidth
                             borderColor:(UIColor *)borderColor {
    return [self crj_imageByRoundCornerRadius:radius
...
- (UIImage *)crj_imageByGrayscale {
    return [self crj_imageByBlurRadius:0 tintColor:nil tintMode:0 saturation:0 maskImage:nil];
}

- (UIImage *)crj_imageByBlurSoft {
    return [self crj_imageByBlurRadius:60 tintColor:[UIColor colorWithWhite:0.84 alpha:0.36] tintMode:kCGBlendModeNormal saturation:1.8 maskImage:nil];
}

- (UIImage *)crj_imageByBlurLight {
    return [self crj_imageByBlurRadius:60 tintColor:[UIColor colorWithWhite:1.0 alpha:0.3] tintMode:kCGBlendModeNormal saturation:1.8 maskImage:nil];
}

- (UIImage *)crj_imageByBlurExtraLight {
    return [self crj_imageByBlurRadius:40 tintColor:[UIColor colorWithWhite:0.97 alpha:0.82] tintMode:kCGBlendModeNormal saturation:1.8 maskImage:nil];
}

- (UIImage *)crj_imageByBlurDark {
    return [self crj_imageByBlurRadius:40 tintColor:[UIColor colorWithWhite:0.11 alpha:0.73] tintMode:kCGBlendModeNormal saturation:1.8 maskImage:nil];
}
...
- (UIImage *)crj_imageByBlurWithTint:(UIColor *)tintColor {
    ...
    return [self crj_imageByBlurRadius:20 tintColor:effectColor tintMode:kCGBlendModeNormal saturation:-1.0 maskImage:nil];
}
...
+ (UIImage *)crj_resizableImage:(NSString *)imgName
{
    ...
    return [self crj_resizableImage:imgName capInsets:UIEdgeInsetsMake(image.size.height *.5f, image.size.width*.5f, image.size.height*.5f, image.size.width*.5f)];
}
